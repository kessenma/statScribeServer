...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<h2 class="h2">Welcome to StatScribe.</h2>
		<!-- Animated Logo -->
		<figure>
		...
		<div class="space-y-2">
			<p>To get started:</p>
			<p><code class="code">1. make an account</code></p>
			<p><code class="code">2. find a research paper (pdf) you'd like to extract statistics from</code></p>
			<p><code class="code">3. navigate to the analysis app</code></p>
			<p><code class="code">4. enter in which statistics you want extracted</code></p>
			<p><code class="code">5. upload your paper and submit</code></p>
			<p><code class="code">6. download the json of extracted statistics</code></p>
		</div>
	</div>
</div>
